...
public class BlockTeleporter extends BlockBreakable {
	...
	public BlockTeleporter() {
		super("VoidCraft:blockTeleporter", Material.portal, false);
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity) {
		if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP))) {
			...
			if (thePlayer.timeUntilPortal > 0) {
				//thePlayer.timeUntilPortal = 10; //Cooldown before you can even enter portal
			}else{
				//thePlayer.timeUntilPortal = 10;
				//voidCraft.instance.tickHandler.addEntityToPortalTimer(thePlayer);
				/*if (thePlayer.dimension != voidCraft.dimensionIdVoid) {
					thePlayer.timeUntilPortal = 10;
