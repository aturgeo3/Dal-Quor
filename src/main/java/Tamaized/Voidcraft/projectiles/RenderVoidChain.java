...
public class RenderVoidChain extends Render
{
    ...
    {
        this.bindEntityTexture(par1voidChain);
        GL11.glPushMatrix();
        ...
        float f11 = (float)par1voidChain.arrowShake - par9;
    ...
    {
    	//if(par1Entity instanceof EntityLivingBase) return null;
        return this.getArrowTextures((VoidChain)par1Entity);
    }
    ...
    {
        this.renderArrow((VoidChain)par1Entity, par2, par4, par6, par8, par9);
    }
}
