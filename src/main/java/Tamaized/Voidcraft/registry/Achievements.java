...
public class Achievements extends RegistryBase {
	...
	public void init() {
		...
		voidCraftAchMainLine_3 = new Achievement("achievement.achM_3", "achM_3", 0, 6, voidCraft.items.ChainedSkull, voidCraftAchMainLine_2).registerStat();
		voidCraftAchMainLine_4 = new Achievement("achievement.achM_4", "achM_4", 0, 9, voidCraft.items.voidStar, voidCraftAchMainLine_3).setSpecial().registerStat();
		voidCraftAchMainLine_5 = new Achievement("achievement.achM_5", "achM_5", 2, 9, voidCraft.blocks.blockNoBreak, voidCraftAchMainLine_4).registerStat();
		voidCraftAchMainLine_6 = new Achievement("achievement.achM_6", "achM_6", 4, 9, voidCraft.blocks.blockPortalXia, voidCraftAchMainLine_5).registerStat();
		...
		voidCraftAchSideLine1_1_1 = new Achievement("achievement.achS1_1_1", "achS1_1_1", 6, 3, voidCraft.tools.chainSword, voidCraftAchSideLine1_1).registerStat();
		voidCraftAchSideLine1_1_2 = new Achievement("achievement.achS1_1_2", "achS1_1_2", 6, 6, voidCraft.tools.moltenSword, voidCraftAchSideLine1_1_1).registerStat();
		voidCraftAchSideLine1_1_3 = new Achievement("achievement.achS1_1_3", "achS1_1_3", 4, 6, voidCraft.tools.archSword, voidCraftAchSideLine1_1_2).setSpecial().registerStat();
		voidCraftAchSideLine1_1_4 = new Achievement("achievement.achS1_1_4", "achS1_1_4", 2, 6, voidCraft.tools.demonSword, voidCraftAchSideLine1_1_3).setSpecial().registerStat();


		voidCraftAchSideLine2_1 = new Achievement("achievement.achS2_1", "achS2_1", -2, 9, voidCraft.blocks.voidInfuser, voidCraftAchMainLine_4).registerStat();
		voidCraftAchSideLine2_2 = new Achievement("achievement.achS2_2", "achS2_2", -2, 6, voidCraft.blocks.voidMacerator, voidCraftAchSideLine2_1).registerStat();
		voidCraftAchSideLine2_3 = new Achievement("achievement.achS2_3", "achS2_3", -2, 3, voidCraft.blocks.Heimdall, voidCraftAchSideLine2_2).registerStat();
	}
