...
public class VoidCraftResearch {
	...
	public void register(){
		ResearchCategories.registerCategory("VoidCraft", new ResourceLocation("VoidCraft:textures/items/Thaumcraft/corruptedSword.png"), new ResourceLocation("VoidCraft:textures/GUI/Thaumcraft/VoidBG-3.gif"));
