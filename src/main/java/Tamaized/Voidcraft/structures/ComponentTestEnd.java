...
public class ComponentTestEnd extends ComponentTestPiece{
    ...
    public ComponentTestEnd(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        super(par1);
    ...
    public static ComponentTestEnd func_74971_a(List par0List, Random par1Random, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        return isAboveGround(structureboundingbox) && StructureComponent.findIntersecting(par0List, structureboundingbox) == null ? new ComponentTestEnd(par6, par1Random, structureboundingbox, par5) : null;
    }
