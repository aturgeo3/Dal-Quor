...
public class ComponentTestEntrance extends ComponentTestPiece{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 5, 8, 0, 7, 8, 0, voidCraft.blockVoidfence, voidCraft.blockVoidfence, false);
        int i;
        ...
        for (i = 4; i <= 8; ++i)
        {
            for (j = 0; j <= 2; ++j)
            {
                ...
                //this.fillCurrentPositionBlocksDownwards(par1World, voidCraft.blockVoidbrick, 0, i, -1, 12 - j, par3StructureBoundingBox);
            }
        }
        ...
        for (i = 0; i <= 2; ++i)
        {
            ...
            {
                //this.fillCurrentPositionBlocksDownwards(par1World, voidCraft.blockVoidbrick, 0, i, -1, j, par3StructureBoundingBox);
                //this.fillCurrentPositionBlocksDownwards(par1World, voidCraft.blockVoidbrick, 0, 12 - i, -1, j, par3StructureBoundingBox);
            }
        }

        this.fillWithBlocks(par1World, par3StructureBoundingBox, 5, 5, 5, 7, 5, 7, voidCraft.blockVoidbrick, voidCraft.blockVoidbrick, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 6, 1, 6, 6, 4, 6, Blocks.air, Blocks.air, false);
        this.placeBlockAtCurrentPosition(par1World, voidCraft.blockVoidbrick, 0, 6, 0, 6, par3StructureBoundingBox);
