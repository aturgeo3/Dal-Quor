...
public class ComponentTestCorridor2 extends ComponentTestPiece{
	 ...
	 private boolean field_111020_b;
	    ...
	    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
	    {
	        ...
	        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 2, 4, 4, 5, 4, voidCraft.blockVoidbrick, voidCraft.blockVoidbrick, false);
	        ...
	        for (i = 0; i <= 4; ++i)
	        {
	            for (j = 0; j <= 4; ++j)
	            {
	                //this.fillCurrentPositionBlocksDownwards(par1World, voidCraft.blockVoidbrick.blockID, 0, i, -1, j, par3StructureBoundingBox);
	            }
	        }
