...
public class StructureTestPieceWeight {
    ...
    public StructureTestPieceWeight(Class par1Class, int par2, int par3, boolean par4)
    {
    ...
    public StructureTestPieceWeight(Class par1Class, int par2, int par3)
    {
