...
public class RenderZol extends RenderLiving
{
    ...
    public void renderZol(EntityBossZol par1EntityWraith, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderZol((EntityBossZol)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.renderZol((EntityBossZol)par1Entity, par2, par4, par6, par8, par9);
    	this.renderLabel((EntityBossZol)par1Entity, par2, par4, par6);
    }
	...
	protected void renderLabel(EntityBossZol yourentityLiving, double par2, double par4, double par6)
	{
	...
	{
	this.renderLabel((EntityBossZol)par1EntityLiving, par2, par4, par6);
	}
}