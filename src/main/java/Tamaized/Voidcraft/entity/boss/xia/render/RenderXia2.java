...
public class RenderXia2 extends RenderLiving
{
	
	 private static final ResourceLocation Herobrine_Texture = new ResourceLocation("VoidCraft:textures/entity/XiaFormTwo.png");  //refers to:assets/yourmod/textures/entity/yourtexture.png
    ...
    public void renderXia2(EntityBossXia2 par1EntityWraith, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.renderXia2((EntityBossXia2)par1EntityLiving, par2, par4, par6, par8, par9);
    }
    ...
    {
        this.renderXia2((EntityBossXia2)par1Entity, par2, par4, par6, par8, par9);
    }
	...
	protected void renderLabel(EntityBossXia2 yourentityLiving, double par2, double par4, double par6)
	{
	...
	{
	this.renderLabel((EntityBossXia2)par1EntityLiving, par2, par4, par6);
	}
}