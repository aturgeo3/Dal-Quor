...
public class EntityDragonXia extends EntityLiving implements IEntityMultiPartXia, IMob, IAlternateBoss {
	...
	public EntityDragonPartXia[] dragonPartArray;
	/** The head bounding box of a dragon */
	public EntityDragonPartXia dragonPartHead;
	/** The body bounding box of a dragon */
	public EntityDragonPartXia dragonPartBody;
	public EntityDragonPartXia dragonPartTail1;
	public EntityDragonPartXia dragonPartTail2;
	public EntityDragonPartXia dragonPartTail3;
	public EntityDragonPartXia dragonPartWing1;
	public EntityDragonPartXia dragonPartWing2;
	...
	public EntityDragonXia(World p_i1700_1_) {
		super(p_i1700_1_);
		this.dragonPartArray = new EntityDragonPartXia[] { this.dragonPartHead = new EntityDragonPartXia(this, "head", 6.0F, 6.0F), this.dragonPartBody = new EntityDragonPartXia(this, "body", 8.0F, 8.0F), this.dragonPartTail1 = new EntityDragonPartXia(this, "tail", 4.0F, 4.0F), this.dragonPartTail2 = new EntityDragonPartXia(this, "tail", 4.0F, 4.0F), this.dragonPartTail3 = new EntityDragonPartXia(this, "tail", 4.0F, 4.0F), this.dragonPartWing1 = new EntityDragonPartXia(this, "wing", 4.0F, 4.0F), this.dragonPartWing2 = new EntityDragonPartXia(this, "wing", 4.0F, 4.0F) };
	...
	public void onLivingUpdate() {
		...
		if (this.getHealth() <= 0.0F) {
			...
			for (int j = 0; j < 3; ++j) {
				EntityDragonPartXia entitydragonpart = null;
	...
	@Override
	public boolean attackEntityFromPart(EntityDragonPartXia p_70965_1_, DamageSource p_70965_2_, float p_70965_3_) {
