...
public class EntityBossXia2 extends EntityVoidBossMob{
    ...
    protected SoundEvent getAmbientSound(){
    	return VoidSoundEvents.EntityMobXia2SoundEvents.ambientSound;
    }
    
    @Override
    protected SoundEvent getHurtSound(){
    	return VoidSoundEvents.EntityMobXia2SoundEvents.hurtSound;
    }
    
    @Override
    protected SoundEvent getDeathSound(){
    	return VoidSoundEvents.EntityMobXia2SoundEvents.deathSound;
    }
