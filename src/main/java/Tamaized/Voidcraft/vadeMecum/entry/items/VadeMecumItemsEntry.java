package Tamaized.Voidcraft.vadeMecum.entry.items;
...
import Tamaized.Voidcraft.vadeMecum.entry.items.chainedskull.VadeMecumPageListChainedSkull;
import Tamaized.Voidcraft.vadeMecum.entry.items.charredbone.VadeMecumPageListCharredBone;
import Tamaized.Voidcraft.vadeMecum.entry.items.dusts.VadeMecumPageListVoidDusts;
import Tamaized.Voidcraft.vadeMecum.entry.items.ectoplasm.VadeMecumPageListEctoplasm;
import Tamaized.Voidcraft.vadeMecum.entry.items.moltenvoidchain.VadeMecumPageListMoltenChain;
import Tamaized.Voidcraft.vadeMecum.entry.items.moltenvoidchainpart.VadeMecumPageListMoltenChainPart;
import Tamaized.Voidcraft.vadeMecum.entry.items.obsidianflask.VadeMecumPageListObsidianFlask;
import Tamaized.Voidcraft.vadeMecum.entry.items.voidchain.VadeMecumPageListVoidChain;
import Tamaized.Voidcraft.vadeMecum.entry.items.voidcloth.VadeMecumPageListVoidCloth;
import Tamaized.Voidcraft.vadeMecum.entry.items.voidcrystal.VadeMecumPageListVoidCrystal;
import Tamaized.Voidcraft.vadeMecum.entry.items.voidicsupressor.VadeMecumPageListSuppressor;
import Tamaized.Voidcraft.vadeMecum.entry.items.voidstar.VadeMecumPageListVoidStar;
