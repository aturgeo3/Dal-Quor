...
public class VadeMecumCraftingAlchemy implements IVadeMecumCrafting {
	...
	public void render(VadeMecumGUI gui, FontRenderer render, int x, int y) {
		...
		if (input[0] != null) gui.renderItemStack(input[0], x + 10, y + 40);
		if (input[1] != null) gui.renderItemStack(input[1], x + 55, y + 40);
		if (input[2] != null) gui.renderItemStack(input[2], x + 100, y + 40);

		if (input[3] != null) gui.renderItemStack(input[3], x + 10, y + 140);
		if (input[4] != null) gui.renderItemStack(input[4], x + 55, y + 142);
		if (input[5] != null) gui.renderItemStack(input[5], x + 106, y + 138);

		gui.renderItemStack(output, x + 56, y + 88);
