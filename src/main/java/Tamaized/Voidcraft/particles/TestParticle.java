...
public class TestParticle extends TamParticle {

	public TestParticle(World world, Vec3d pos, Vec3d target) {
	...
	public TestParticle setGravity(float gravity) {
		particleGravity = gravity;
		return this;
	}

	public TestParticle setScale(float scale) {
		particleScale = scale;
		return this;
	}
