...
public class TileEntityHeimdall extends TamTileEntityInventory implements IFluidHandler, IEnergyStorage {
	...
	public boolean isItemValidForSlot(int slot, ItemStack itemstack) {
		return slot == SLOT_BUCKET ? (itemstack.getItem() == Items.BUCKET && getStackInSlot(SLOT_BUCKET).isEmpty()) : slot == SLOT_INPUT ? itemstack.getItem() == VoidCraft.items.quartzDust : false;
	}
