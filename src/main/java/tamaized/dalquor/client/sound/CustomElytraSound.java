package tamaized.dalquor.client.sound;
...
import tamaized.dalquor.common.events.CustomElytraHandler;

public class CustomElytraSound extends MovingSound {
	private final EntityPlayerSP player;
	private int time;

	public CustomElytraSound(EntityPlayerSP p_i47113_1_) {
	...
	public void update() {
		...
		if (!this.player.isDead && (this.time <= 20 || CustomElytraHandler.isElytraFlying(player))) {
