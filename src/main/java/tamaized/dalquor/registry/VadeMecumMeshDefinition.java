...
public class VadeMecumMeshDefinition implements ItemMeshDefinition {
	...
	private static final ModelResourceLocation closed = new ModelResourceLocation(new ResourceLocation(DalQuor.modid, "items/vademecum"), "inventory");
	private static final ModelResourceLocation open = new ModelResourceLocation(new ResourceLocation(DalQuor.modid, "items/vademecum_open"), "inventory");
