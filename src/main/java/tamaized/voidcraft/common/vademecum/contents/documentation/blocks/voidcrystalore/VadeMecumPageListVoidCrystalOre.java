...
public class VadeMecumPageListVoidCrystalOre implements IVadeMecumPageProvider {
	...
	public IVadeMecumPage[] getPageList(IVadeMecumCapability cap) {
		return new IVadeMecumPage[]{new VadeMecumPage(new ItemStack(VoidCraft.blocks.oreVoidcrystal).getDisplayName(), VoidCraft.modid + ".VadeMecum.docs.desc.voidCrystalOre"),};
	}
