...
public class VadeMecumPageListQuoriFragment implements IVadeMecumPageProvider {
	...
	public IVadeMecumPage[] getPageList(IVadeMecumCapability cap) {
		return new IVadeMecumPage[]{new VadeMecumPage(new ItemStack(VoidCraft.items.quoriFragment).getDisplayName(), VoidCraft.modid + ".VadeMecum.docs.desc.quoriFragment")};
	}
