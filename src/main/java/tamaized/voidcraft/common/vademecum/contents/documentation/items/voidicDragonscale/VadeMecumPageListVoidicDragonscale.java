...
public class VadeMecumPageListVoidicDragonscale implements IVadeMecumPageProvider {
	...
	public IVadeMecumPage[] getPageList(IVadeMecumCapability cap) {
		return new IVadeMecumPage[]{new VadeMecumPage(new ItemStack(VoidCraft.items.voidicDragonScale).getDisplayName(), VoidCraft.modid + ".VadeMecum.docs.desc.voidicDragonScale")};
	}
