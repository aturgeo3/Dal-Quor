...
public class ChunkGenTest implements IChunkGenerator {

	private final MapGenVoidFortress genFortress = new MapGenVoidFortress();
	...
	public ChunkGenTest(World worldIn, boolean mapFeaturesEnabledIn, long seed) {
		world = worldIn;
	...
	public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos) {
		...
		if (genFortress.isPositionInStructure(world, pos) && world.getBlockState(pos.down()).getBlock() == VoidCraftBlocks.blockVoidbrick) {
		...
		if (pos.getY() >= 128) {
			...
			if (state != null && state.getBlock() == VoidCraftBlocks.blockVoidbrick && world.rand.nextInt(5) == 0) {
