...
public class VoidicAnchorGUI extends GuiContainer {
	...
	private static final ResourceLocation TEXTURE = new ResourceLocation(VoidCraft.modid, "textures/gui/anchor.png");

	public VoidicAnchorGUI(InventoryPlayer inventoryPlayer, TileEntityVoidicAnchor tileEntity) {
		super(new VoidicAnchorContainer(inventoryPlayer, tileEntity));
		te = tileEntity;
		xSize = 347;
		ySize = 320;
		gleft = guiLeft;
